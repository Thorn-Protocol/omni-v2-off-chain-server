...
export interface AerodromeNonfungiblePositionManagerInterface
  extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
...
export namespace TokenDescriptorChangedEvent {
  export type InputTuple = [tokenDescriptor: AddressLike];
  export type OutputTuple = [tokenDescriptor: string];
  export interface OutputObject {
...
export interface AerodromeNonfungiblePositionManager extends BaseContract {
  connect(runner?: ContractRunner | null): AerodromeNonfungiblePositionManager;
  waitForDeployment(): Promise<this>;

  interface: AerodromeNonfungiblePositionManagerInterface;
  ...
  setTokenDescriptor: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "setTokenDescriptor"
  ): TypedContractMethod<[_tokenDescriptor: AddressLike], [void], "nonpayable">;
  getFunction(
  ...
  >;
  getEvent(
    key: "TokenDescriptorChanged"
  ): TypedContractEvent<
    TokenDescriptorChangedEvent.InputTuple,
    TokenDescriptorChangedEvent.OutputTuple,
    TokenDescriptorChangedEvent.OutputObject
  >;
  getEvent(
    key: "Transfer"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "TokenDescriptorChanged(address)": TypedContractEvent<
      TokenDescriptorChangedEvent.InputTuple,
      TokenDescriptorChangedEvent.OutputTuple,
      TokenDescriptorChangedEvent.OutputObject
    >;
    TokenDescriptorChanged: TypedContractEvent<
      TokenDescriptorChangedEvent.InputTuple,
      TokenDescriptorChangedEvent.OutputTuple,
      TokenDescriptorChangedEvent.OutputObject
    >;
    ...
    "TransferOwnership(address)": TypedContractEvent<
      TransferOwnershipEvent.InputTuple,
      TransferOwnershipEvent.OutputTuple,
      TransferOwnershipEvent.OutputObject
    >;

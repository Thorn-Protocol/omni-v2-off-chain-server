...
export interface AerodromeSlipRouterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH9"
      | "exactInput"
...
export interface AerodromeSlipRouter extends BaseContract {
  connect(runner?: ContractRunner | null): AerodromeSlipRouter;
  waitForDeployment(): Promise<this>;

  interface: AerodromeSlipRouterInterface;

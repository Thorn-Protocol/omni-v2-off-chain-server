...
export interface AerodromeSlipstreamQuoterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH9"
      | "factory"
...
export interface AerodromeSlipstreamQuoter extends BaseContract {
  connect(runner?: ContractRunner | null): AerodromeSlipstreamQuoter;
  waitForDeployment(): Promise<this>;

  interface: AerodromeSlipstreamQuoterInterface;

...
import type {
  PoolProxyBase,
  PoolProxyBaseInterface,
} from "../../AaveV3/PoolProxyBase";
...
export class PoolProxyBase__factory {
  static readonly abi = _abi;
  static createInterface(): PoolProxyBaseInterface {
    return new Interface(_abi) as PoolProxyBaseInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): PoolProxyBase {
    return new Contract(address, _abi, runner) as unknown as PoolProxyBase;
  }
}

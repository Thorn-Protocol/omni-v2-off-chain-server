...
import type {
  AerodromeFactory,
  AerodromeFactoryInterface,
} from "../../AerodromeSlip/AerodromeFactory";
...
export class AerodromeFactory__factory {
  static readonly abi = _abi;
  static createInterface(): AerodromeFactoryInterface {
    return new Interface(_abi) as AerodromeFactoryInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): AerodromeFactory {
    return new Contract(address, _abi, runner) as unknown as AerodromeFactory;
  }
}

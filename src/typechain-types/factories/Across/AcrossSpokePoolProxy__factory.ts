...
import type {
  AcrossSpokePoolProxy,
  AcrossSpokePoolProxyInterface,
} from "../../Across/AcrossSpokePoolProxy";
...
export class AcrossSpokePoolProxy__factory {
  static readonly abi = _abi;
  static createInterface(): AcrossSpokePoolProxyInterface {
    return new Interface(_abi) as AcrossSpokePoolProxyInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as AcrossSpokePoolProxy;
  }
}

...
import type { AerodromePool, AerodromePoolInterface } from "../AerodromePool";
...
export class AerodromePool__factory {
  static readonly abi = _abi;
  static createInterface(): AerodromePoolInterface {
    return new Interface(_abi) as AerodromePoolInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): AerodromePool {
    return new Contract(address, _abi, runner) as unknown as AerodromePool;
  }
}
